...
// Type simplifié pour la prop variant
type VariantProp = {
...
const BentoGrid = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & VariantProp
...
const BentoCell = React.forwardRef<HTMLDivElement, any>(
...
const ContainerScale = React.forwardRef<HTMLDivElement, any>(
  ({ className, style, ...props }, ref) => {
    const { scrollYProgress } = useContainerScrollContext()
